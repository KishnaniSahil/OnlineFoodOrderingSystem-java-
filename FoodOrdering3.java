...
class Thankyou extends JFrame
{
	JLabel t,limage;
	 ...
	 Thankyou()
	 {
		 ...
		 t.setFont(f);
		 ImageIcon i=new ImageIcon("D:\\Sahilkjava2021\\thankyoufinal.jpeg");		
		 limage=new JLabel(i);
		 t.setBounds(550,700,500,50);
...
class Desserts extends JFrame implements ActionListener
{
	...
	Desserts()
	{
		...
		p2=new JLabel("Price");
		q2=new JLabel("Qty");
		ImageIcon i=new ImageIcon("D:\\Sahilkjava2021\\Desserts.jpg");		
		limage=new JLabel(i);
		//b1=new JButton("NEXT");
		b2=new JButton("PREV");
...
class Drinks extends JFrame implements ActionListener
{
	...
	Drinks()
	{
		...
		ImageIcon i=new ImageIcon("D:\\Sahilkjava2021\\Drink3.jpg");
		limage=new JLabel(i); 
		d=new JLabel("DRINKS");
		m1=new JLabel("Menu");
		p1=new JLabel("Price");
...
class italy_veg extends JFrame implements ActionListener
{
	...
	italy_veg()
	{
		...
		ImageIcon i=new ImageIcon("D:\\Sahilkjava2021\\Italianveg.jpeg");
		limage=new JLabel(i); 
...
class mexican_veg extends JFrame implements ActionListener
{
	...
	mexican_veg()
	{
		l1=new JLabel("      Menu                              Price                               QTY");
		l2=new JLabel("      Menu                              Price                               QTY");
		ImageIcon i=new ImageIcon("D:\\Sahilkjava2021\\Mexicanveg.jpeg");
		limage=new JLabel(i); 
		//s=new JLabel("STARTERS");
		//lamount=new JLabel();
...
class Indianveg extends JFrame implements ActionListener
{
	...
	Indianveg()
	{
		...
		l1=new JLabel("      Menu                              Price                               QTY");
		l2=new JLabel("      Menu                              Price                               QTY");
		ImageIcon i=new ImageIcon("D:\\Sahilkjava2021\\indianveg.jpeg");
		limage=new JLabel(i);
...
class delivery1 extends JFrame implements ActionListener
{
	...
	delivery1()
	{
		ImageIcon i=new ImageIcon("D:\\Sahilkjava2021\\Cuisinefinal.jpg");
		limage=new JLabel(i); 
...
class delivery extends JFrame implements ActionListener
{
	...
	delivery()
	{
		ImageIcon i=new ImageIcon("D:\\Sahilkjava2021\\vnv.jpeg");
		limage=new JLabel(i); 
		t1=new JButton("Indian");
		t2=new JButton("Chinese");
		t3=new JButton("Mexican");
...
class order extends JFrame implements ActionListener
{
	...
	order()
	{
		ImageIcon i=new ImageIcon("D:\\Sahilkjava2021\\Hotel.jpg");
		limage=new JLabel(i); 
		d1=new JButton("VEG");
...
class market extends JFrame implements ActionListener
{
	...
	market()
	{
		ImageIcon i=new ImageIcon("D:\\Sahilkjava2021\\Hotels.jpg");
		limage=new JLabel(i); 
